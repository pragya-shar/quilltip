        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              disabled={isLoading}
              placeholder="0.00"
              className="w-full pl-8 pr-4 py-2 border border-input bg-background text-foreground rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent disabled:opacity-50"
            />
          </div>
